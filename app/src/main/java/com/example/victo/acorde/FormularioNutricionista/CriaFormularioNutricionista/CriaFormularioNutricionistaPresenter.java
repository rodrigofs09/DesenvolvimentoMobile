...
public class CriaFormularioNutricionistaPresenter implements CriaFormularioNutricionistaContract.Presenter {
    ...
    public void setFormularioNutricionista(String dataAtendimento, String nomeAssistido, String motivoAtendimento,
                                           String encaminhamento, String idade, String altura, String peso, String cintura, String quadril,
        ...
        formularioNutricionista.setIdade(idade);
    ...
    public void getFormularioNutricionista() {
        if (formularioNutricionista != null){
            view.setInfosFormularioNutricionista(formularioNutricionista.getDataAtendimento(), formularioNutricionista.getNomeAssistido(), formularioNutricionista.getMotivoAtendimento(), formularioNutricionista.getEncaminhamento(), formularioNutricionista.getIdade(), formularioNutricionista.getAltura(),
