...
public class NutricionistaHelper {
    ...
    public NutricionistaHelper(NutricionistaActivity activity) {
        ...
        //campoAlimentarSozinho = activity.findViewById(verificaRadioButton(activity, (RadioGroup) activity.findViewById(R.id.RadioGroupAlimentarSozinho)));
    ...
    public int verificaRadioButton(NutricionistaActivity activity, RadioGroup rg){
