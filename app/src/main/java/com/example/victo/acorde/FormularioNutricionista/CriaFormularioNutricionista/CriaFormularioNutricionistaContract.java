...
public interface CriaFormularioNutricionistaContract {
    ...
    interface View {
        void setInfosFormularioNutricionista(String dataAtendimento, String nomeAssistido, String motivoAtendimento, String encaminhamento, String idade,
    ...
    interface Presenter {
        ...
        void setFormularioNutricionista(String dataAtendimento, String nomeAssistido, String motivoAtendimento, String encaminhamento, String idade,
